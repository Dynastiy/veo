      ...
      <div class="user--login">
        <div class="login--box">
          <div class="mb-4 text-center">
            ...
            <h4 class="font-weight-bold ">Corporate Login</h4>
            <p class="small">Enter details to login</p>
          </div>
         <form action="" @submit.prevent="login">
            <div class="mb-3">
              <label class="" for="">Corporate Email</label>
            ...
            <div>
              ...
              <button type="submit" class="main--btn login w-100" v-else>Login</button>
            </div>
          </form>
          
           <div class="text-right mt-4">
            <span class=""> <router-link to="/register" class="text-main font-weight-bold">Forgot Password?</router-link></span>
          </div>  
...
export default {
  ...
  methods: {
    async login() {
      this.loading = true;
      this.$router.push({name: 'Corporate Dashboard'})
      // try {
